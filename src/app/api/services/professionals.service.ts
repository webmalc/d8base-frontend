...
class ProfessionalsService extends __BaseService {
     ...
     */
    professionalsCategoriesListResponse(
        params: ProfessionalsService.ProfessionalsCategoriesListParams
    ): __Observable<__StrictHttpResponse<{ count: number; next?: null | string; previous?: null | string; results: Array<Category> }>> {
        ...
        let req = new HttpRequest<any>('GET', this.rootUrl + `/professionals/categories/`, __body, {
            headers: __headers,
            params: __params,
            responseType: 'json'
        });
    ...
    professionalsCategoriesList(
        params: ProfessionalsService.ProfessionalsCategoriesListParams
    ): __Observable<{ count: number; next?: null | string; previous?: null | string; results: Array<Category> }> {
    ...
    professionalsCategoriesReadResponse(id: number): __Observable<__StrictHttpResponse<Category>> {
        ...
        let req = new HttpRequest<any>('GET', this.rootUrl + `/professionals/categories/${encodeURIComponent(id)}/`, __body, {
            headers: __headers,
            params: __params,
            responseType: 'json'
        });
    ...
    professionalsCategoriesRead(id: number): __Observable<Category> {
        return this.professionalsCategoriesReadResponse(id).pipe(__map(_r => _r.body as Category));
    }
     ...
     * - `ordering`: Which field to use when ordering the results.
     */
    professionalsProfessionalPhotosListResponse(
        params: ProfessionalsService.ProfessionalsProfessionalPhotosListParams
    ): __Observable<
        __StrictHttpResponse<{ count: number; next?: null | string; previous?: null | string; results: Array<ProfessionalPhotoList> }>
    > {
        let __params = this.newParams();
        let __headers = new HttpHeaders();
        let __body: any = null;
        ...
        if (params.page != null) __params = __params.set('page', params.page.toString());
        if (params.ordering != null) __params = __params.set('ordering', params.ordering.toString());
        let req = new HttpRequest<any>('GET', this.rootUrl + `/professionals/professional-photos/`, __body, {
            headers: __headers,
            params: __params,
            responseType: 'json'
        });
        ...
        return this.http.request<any>(req).pipe(
            ...
            __map(_r => {
                return _r as __StrictHttpResponse<{
                    ...
                    next?: null | string;
                    previous?: null | string;
                    results: Array<ProfessionalPhotoList>;
                }>;
            })
        );
    }
     ...
     * - `ordering`: Which field to use when ordering the results.
     */
    professionalsProfessionalPhotosList(
        params: ProfessionalsService.ProfessionalsProfessionalPhotosListParams
    ): __Observable<{ count: number; next?: null | string; previous?: null | string; results: Array<ProfessionalPhotoList> }> {
    ...
    professionalsProfessionalPhotosReadResponse(id: number): __Observable<__StrictHttpResponse<ProfessionalPhotoList>> {
        ...
        let req = new HttpRequest<any>('GET', this.rootUrl + `/professionals/professional-photos/${encodeURIComponent(id)}/`, __body, {
            headers: __headers,
            params: __params,
            responseType: 'json'
        });
    ...
    professionalsProfessionalPhotosRead(id: number): __Observable<ProfessionalPhotoList> {
        return this.professionalsProfessionalPhotosReadResponse(id).pipe(__map(_r => _r.body as ProfessionalPhotoList));
    }
     ...
     * - `experience`:
     */
    professionalsProfessionalsListResponse(
        params: ProfessionalsService.ProfessionalsProfessionalsListParams
    ): __Observable<
        __StrictHttpResponse<{ count: number; next?: null | string; previous?: null | string; results: Array<ProfessionalList> }>
    > {
        let __params = this.newParams();
        let __headers = new HttpHeaders();
        let __body: any = null;
        ...
        let req = new HttpRequest<any>('GET', this.rootUrl + `/professionals/professionals/`, __body, {
            headers: __headers,
            params: __params,
            responseType: 'json'
        });
        ...
        return this.http.request<any>(req).pipe(
            ...
            __map(_r => {
                return _r as __StrictHttpResponse<{
                    ...
                    next?: null | string;
                    previous?: null | string;
                    results: Array<ProfessionalList>;
                }>;
            })
        );
    }
    ...
    professionalsProfessionalsList(
        params: ProfessionalsService.ProfessionalsProfessionalsListParams
    ): __Observable<{ count: number; next?: null | string; previous?: null | string; results: Array<ProfessionalList> }> {
    ...
    professionalsProfessionalsReadResponse(id: number): __Observable<__StrictHttpResponse<ProfessionalList>> {
        ...
        let req = new HttpRequest<any>('GET', this.rootUrl + `/professionals/professionals/${encodeURIComponent(id)}/`, __body, {
            headers: __headers,
            params: __params,
            responseType: 'json'
        });
    ...
    professionalsProfessionalsRead(id: number): __Observable<ProfessionalList> {
        return this.professionalsProfessionalsReadResponse(id).pipe(__map(_r => _r.body as ProfessionalList));
    }
     ...
     * - `category`:
     */
    professionalsSubcategoriesListResponse(
        params: ProfessionalsService.ProfessionalsSubcategoriesListParams
    ): __Observable<__StrictHttpResponse<{ count: number; next?: null | string; previous?: null | string; results: Array<Subcategory> }>> {
        let __params = this.newParams();
        let __headers = new HttpHeaders();
        let __body: any = null;
        if (params.search != null) __params = __params.set('search', params.search.toString());
        ...
        let req = new HttpRequest<any>('GET', this.rootUrl + `/professionals/subcategories/`, __body, {
            headers: __headers,
            params: __params,
            responseType: 'json'
        });
    ...
    professionalsSubcategoriesList(
        params: ProfessionalsService.ProfessionalsSubcategoriesListParams
    ): __Observable<{ count: number; next?: null | string; previous?: null | string; results: Array<Subcategory> }> {
    ...
    professionalsSubcategoriesReadResponse(id: number): __Observable<__StrictHttpResponse<Subcategory>> {
        ...
        let req = new HttpRequest<any>('GET', this.rootUrl + `/professionals/subcategories/${encodeURIComponent(id)}/`, __body, {
            headers: __headers,
            params: __params,
            responseType: 'json'
        });
    ...
    professionalsSubcategoriesRead(id: number): __Observable<Subcategory> {
        return this.professionalsSubcategoriesReadResponse(id).pipe(__map(_r => _r.body as Subcategory));
    }
     ...
     * - `ordering`: Which field to use when ordering the results.
     */
    professionalsTagsListResponse(
        params: ProfessionalsService.ProfessionalsTagsListParams
    ): __Observable<
        __StrictHttpResponse<{ count: number; next?: null | string; previous?: null | string; results: Array<ProfessionalTagList> }>
    > {
        let __params = this.newParams();
        let __headers = new HttpHeaders();
        let __body: any = null;
        ...
        if (params.page != null) __params = __params.set('page', params.page.toString());
        if (params.ordering != null) __params = __params.set('ordering', params.ordering.toString());
        let req = new HttpRequest<any>('GET', this.rootUrl + `/professionals/tags/`, __body, {
            headers: __headers,
            params: __params,
            responseType: 'json'
        });
        ...
        return this.http.request<any>(req).pipe(
            ...
            __map(_r => {
                return _r as __StrictHttpResponse<{
                    ...
                    next?: null | string;
                    previous?: null | string;
                    results: Array<ProfessionalTagList>;
                }>;
            })
        );
    }
    ...
    professionalsTagsList(
        params: ProfessionalsService.ProfessionalsTagsListParams
    ): __Observable<{ count: number; next?: null | string; previous?: null | string; results: Array<ProfessionalTagList> }> {
    ...
    professionalsTagsReadResponse(id: number): __Observable<__StrictHttpResponse<ProfessionalTagList>> {
        ...
        let req = new HttpRequest<any>('GET', this.rootUrl + `/professionals/tags/${encodeURIComponent(id)}/`, __body, {
            headers: __headers,
            params: __params,
            responseType: 'json'
        });
    ...
    professionalsTagsRead(id: number): __Observable<ProfessionalTagList> {
        return this.professionalsTagsReadResponse(id).pipe(__map(_r => _r.body as ProfessionalTagList));
    }
}
