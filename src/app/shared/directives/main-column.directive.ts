...
export class MainColumnDirective {
    ...
    @HostBinding(`attr.${SizeAttr.Sm}`) public get sizeSm(): number {
        return MAIN_COLUMN_SIZE[SizeAttr.Sm];
    }
    @HostBinding(`attr.${SizeAttr.Md}`) public get sizeMd(): number {
        return MAIN_COLUMN_SIZE[SizeAttr.Md];
    }
    @HostBinding(`attr.${SizeAttr.Lg}`) public get sizeLg(): number {
        return MAIN_COLUMN_SIZE[SizeAttr.Lg];
    }
    @HostBinding(`attr.${SizeAttr.Xl}`) public get sizeXl(): number {
